...
const industries: IndustryTab[] = [
  {
    ...
    description:
      "Sports technology products often bring together athletes, coaches, teams, leagues, organizations, fans, and data. Product development needs to translate those different workflows into a product experience that remains clear and useful.",
    tags: [
  ...
  },
  {
    id: "ecommerce",
    label: "Ecommerce",
    cardLabel: "Ecommerce Product Development",
    question: (
      <>
        The store exists, but the{" "}
        <strong>full customer journey still feels broken</strong>?
      </>
    ),
    description:
...
export function PdIndustrySection() {
  ...
  return (
    <section
      ...
      id="sports-ecommerce"
      aria-labelledby="pd-fp-heading"
    >
      <div className="mx-auto w-full max-w-[1300px] px-5 py-14 md:px-8 md:py-16 lg:px-[40px] lg:py-[72px]">
        <h2 id="pd-fp-heading" className="pd-fp-heading">
          Product Development for Sports &amp; Ecommerce
